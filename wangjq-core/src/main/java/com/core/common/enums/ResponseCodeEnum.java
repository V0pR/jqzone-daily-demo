...
public enum ResponseCodeEnum {
     ...
     * CORE
     */
    CORE_ACCESS_DENIED(520, "访问拒绝"),

    CORE_SIGNATURE(530, "签名失效");
    ...
    ResponseCodeEnum(int value, String reasonPhrase) {
        this.value = value;
     ...
     * <p>Retrievable via {@link ResponseCodeEnum#series()}.
     */
    public enum Series {
